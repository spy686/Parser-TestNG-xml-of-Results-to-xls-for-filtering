...
public class RunTestNGResultsParserToXls {
    ...
    private static final By FAILED_TESTS_NAMES_LOCATOR = By.xpath("//div[@class='stacktrace']/preceding::h3[@id]");
    private static final By FAILED_TESTS_STACKTRACE_LOCATOR = By.xpath("//h3[@id]//following-sibling::*//div[@class='stacktrace']");
